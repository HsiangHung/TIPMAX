...
I chose to use Spark to do batch process to store the taxi data in Cassandra, ordered by time, and then one can input a date and time to visualize the pick-up locations, tips and fare profiles using flask with MapBox.
